    ...
    return (
        <>
            ...
            >
                ...
                {alertMsg && (
                    <Alert
                        description={formDataMsg?.message}
                        type={alertMsg?.type === "success" ? "success" : "error"}
                        closable
                    />
                )}
                <div className="mt-5">
                    ...
                    <div className="mb-7 mt-7 ">
                        <div className="flex flex-row gap-9">
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-neutral-900">
                        ...
                        <textarea
                            ...
                            {...register("query", {
                                ...
                                minLength: {
                                    value: 50,
                                    message:
                                        "Query must be at least 50 characters",
                                },
                            })}
                        />
