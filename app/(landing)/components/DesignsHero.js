  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl text-center">
        <h1 className="mb-3 text-2xl font-bold leading-[1.1] tracking-tight sm:mb-5 sm:text-6xl lg:text-7xl">
          <span className="bg-gradient-to-r from-[#e64169] via-[#f8843f] to-[#f3d461] bg-clip-text text-transparent">
            Our designs
          </span>
        </h1>

        <p className=" w-full text-base font-normal leading-relaxed tracking-[0.02em] text-white sm:text-[30px] sm:tracking-[0.03em] lg:text-[40px] w-full">
